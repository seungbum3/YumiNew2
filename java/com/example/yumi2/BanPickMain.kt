...
class BanPickMain : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<Button>(R.id.BanPick_Friend_StartBtn).setOnClickListener {
            ...
            createBanPickRoom(isTimerEnabled)
        }
    ...
    private fun createBanPickRoom(isTimerEnabled: Boolean) {
        ...
        val roomData = mapOf(
            "status"    to "waiting",
            "createdBy" to uid,
            "isTimerEnabled" to isTimerEnabled, // 🔥 이 줄 추가
            "blueTeam"  to mapOf(
                "uid"   to uid,
        ...
        FirebaseFirestore.getInstance()
            ...
            .addOnSuccessListener {
                ...
                Intent(this, BanpickFriendChampionActivity::class.java).apply {
                    putExtra("roomCode", roomCode)
                    putExtra("team",     "blue")
                    putExtra("isTimerEnabled", isTimerEnabled) // ✅ 핵심
                    startActivity(this)
                }
            }
            .addOnFailureListener { e ->
